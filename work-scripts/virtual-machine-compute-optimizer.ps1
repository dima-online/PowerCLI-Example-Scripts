...
#
# NAME: Virtual_Machine_Compute_Optimizer.ps1, v1.0.2
#
...
$defaultPath = "D:\VEEAM\VMCO_Report.csv"
...
$vmHosts = get-view -ViewType HostSystem -Filter $hostFilter | select Name,@{n='Id';e={$_.MoRef}},@{n='Version';
...
$vms = get-view -ViewType VirtualMachine -Filter $vmFilter | select Name, @{n='MemoryGB';e={[int](($_.Config.Hardware.MemoryMB)/1024)}},@{n='Sockets';
    e={($_.Config.Hardware.NumCPU)/($_.Config.Hardware.NumCoresPerSocket)}},@{n='CoresPerSocket'; e={$_.Config.Hardware.NumCoresPerSocket}},@{n='NumCPU';
    e={$_.Config.Hardware.NumCPU}},@{n='VMHostId';e={$_.Runtime.Host}},@{n='vCenter';e={([uri]$_.client.ServiceUrl).Host}}
...
foreach ($vm in $vms)
{
    ...
    If ($vmHost -ne $null)
    {
        ...
        If ($optCPU -ne "ERROR")
        {
            ...
            #$arrInfo = [Array]$arrInfo + $objHostInfo
